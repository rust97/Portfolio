...
function Project(_ref) {
  ...
  if (item.link.content.length > 1) {
    console.log(item.title.content[0].content[0].value);
    console.log(item.link.content[1].content[1].content[0].value);
    console.log(item.link.content[1].content[1].data.uri);
...
//# sourceMappingURL=portfolio.js.642677cb25a8ec924a2c.hot-update.js.map